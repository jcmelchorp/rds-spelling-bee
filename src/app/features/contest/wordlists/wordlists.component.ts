...
@Component({
  ...
  background-position: 54px 55px, 0px 0px, 0px 0px, 0px 0px, 0px 0px;
    ...
    imports: [AsyncPipe, NgForOf, ReactiveFormsModule, FormsModule, MatCardModule, MatButtonModule, MatIconModule, MatFormFieldModule, MatExpansionModule, MatChipListbox,MatChipOption,MatChipRow],
